...
| [code-standards.mdc](code-standards.mdc) | Code-Stil, Architektur-Grundsätze, Qualitäts-Gates, Projektstruktur |
| [mcp-server-architecture.mdc](mcp-server-architecture.mdc) | MCP-Server: Transport, Tool-Namenskonvention, Selbstbeschreibung, Settings, Arbeitsverzeichnis, Logging |
