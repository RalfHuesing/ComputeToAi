...
9. **Cash-Bucket auffüllen**: Die Ziel-Bucket-Größe für das laufende Jahr wird neu berechnet (siehe unten). Die Sparquote füllt vorrangig den Bucket bis zur Zielgröße auf; erst der überschüssige Betrag fließt ins Portfolio. Reicht die Sparquote nicht aus, wird ersatzweise aus dem Portfolio verkauft.
...
12. **Ruin-Prüfung**: Reichen Cash-Bucket und Portfolio zusammen nicht aus, um eine fällige Entnahme, Anschaffung, Verbindlichkeiten-Rate oder Steuerzahlung zu decken, gilt der Lauf ab diesem Jahr als „Ruin" (die finanzspezifische Zielbedingung, siehe 01).
13. Wiederholen bis zum angenommenen Lebensende. Am Ende steht das (nach Steuern) verbleibende Endvermögen dieses Laufs.

## Korrelation zwischen Anlageklassen

Die Jahresrenditen der Anlageklassen werden nicht unabhängig voneinander gezogen, sondern gemeinsam aus einer multivariaten Verteilung mit einer Korrelationsmatrix (technisch z. B. über eine Cholesky-Zerlegung oder Bootstrapping historischer, gemeinsam beobachteter Jahresrenditen) – die finanzspezifische Ausprägung des generischen Korrelations-Konzepts aus 01. Das ist Standard in der quantitativen Portfoliotheorie seit Markowitz (1952).
