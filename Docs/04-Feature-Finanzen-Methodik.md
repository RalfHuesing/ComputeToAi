...
- **Verkaufspriorität**: Eine Entnahme aus einer Anlageklasse (Rentenlücke, Anschaffung, Cash-Bucket-Auffüllung) wird zuerst aus den Positionen bzw. Lots ohne Bestandsschutz-Vorteil entnommen (FIFO über alle nicht geschützten Lots der Anlageklasse hinweg), erst wenn diese erschöpft sind aus Bestandsschutz-Lots.
